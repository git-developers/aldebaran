...
class RadioElement extends gridLayout implements IElement
{
    ...
    function processTag(Form $form, Element $element)
    {
        ...
        $out .= "<span class='input-group-addon' title='{$element->getTagName()}'><i class='fa fa-fw fa-dot-circle-o'></i></span>";
